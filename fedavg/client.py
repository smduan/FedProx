...
class Client(object):
    ...
    def __init__(self, conf, model, train_df):
        ...
        self.train_loader = torch.utils.data.DataLoader(self.train_dataset, batch_size=conf["batch_size"],shuffle=True,drop_last=False)
...
class Client_fedprox(object):
    ...
    def local_train(self, model, global_weight_collector, mu):
        ...
        for e in range(self.conf["local_epochs"]):
            ...
            for batch_id, batch in enumerate(self.train_loader):
                ...
                #for fedprox
                fed_prox_reg = 0.0
                for param_index, param in enumerate(self.local_model.parameters()):
